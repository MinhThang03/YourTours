...
public enum YourToursErrorCode implements IErrorCode {
    ...
    BOOKING_HOME_IS_NOT_REFUND(HttpStatus.BAD_REQUEST, "400000025", "Chính sách của ngôi nhà không cho phép hủy"),
    ...
    NOT_FOUND_PROVINCE(HttpStatus.NOT_FOUND, "40400030", "Không tìm thấy tỉnh thành"),
    NOT_FOUND_NOTIFICATION(HttpStatus.NOT_FOUND, "40400031", "Không tìm thấy thông báo"),
